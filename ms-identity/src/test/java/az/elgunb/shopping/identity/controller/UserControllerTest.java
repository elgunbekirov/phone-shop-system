...
class UserControllerTest {
    ...
    @Test
    @WithMockUser(username = "elgunbekirov@gmail.com", authorities = "view_user_list")
    ...
    @Test
    @WithMockUser(username = "almammadov.elchin@gmail.com")
    ...
    @Test
    @WithMockUser(username = "elgunbekirov@gmail.com", authorities = "view_user")
    void getUser_whenCorrectUserId_thenReturnAppropriateUser() throws Exception {
        mockMvc.perform(get("/api/users/1")
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.username", is("elgunbekirov@gmail.com")));
    }
