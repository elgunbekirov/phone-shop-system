package az.elgunb.shopping.notification.service;
...
public class MailService {
    ...
    public void sendPhoneOrderInfo(EmailNotificationEvent event) {
        ...
        String content = templateEngine.process("phoneOrderInfo", context);
        sendEmail(event.getEmail(), "Phone Order Info", content, false, true);
    }
