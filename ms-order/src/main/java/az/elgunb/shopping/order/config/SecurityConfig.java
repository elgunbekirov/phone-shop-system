package az.elgunb.shopping.order.config;
...
import static az.elgunb.shopping.common.security.enums.Permissions.ACCEPT_ORDER;
import static az.elgunb.shopping.common.security.enums.Permissions.ASSIGN_CUSTOMER;
import static az.elgunb.shopping.common.security.enums.Permissions.CANCEL_ORDER;
import static az.elgunb.shopping.common.security.enums.Permissions.CHANGE_ORDER_DESTINATION;
import static az.elgunb.shopping.common.security.enums.Permissions.CHANGE_ORDER_STATUS;
import static az.elgunb.shopping.common.security.enums.Permissions.CREATE_ORDER;
import static az.elgunb.shopping.common.security.enums.Permissions.UPDATE_ORDER;
import static az.elgunb.shopping.common.security.enums.Permissions.VIEW_ORDER;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        .and()
            ...
            .antMatchers(HttpMethod.PUT, "/api/orders/assign-customer").hasAuthority(ASSIGN_CUSTOMER.get())
